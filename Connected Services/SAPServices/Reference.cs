...
namespace SAPServices {
    ...
    public interface Z_MPG {
        ...
        [System.ServiceModel.OperationContractAttribute(Action = "urn:sap-com:document:sap:rfc:functions:Z_MPG:Z_INITIALMPGDOWNLOADRequest", ReplyAction = "urn:sap-com:document:sap:rfc:functions:Z_MPG:Z_INITIALMPGDOWNLOADResponse")]
        ...
        [System.ServiceModel.OperationContractAttribute(Action = "urn:sap-com:document:sap:rfc:functions:Z_MPG:Z_MPGCONSUMRequest", ReplyAction = "urn:sap-com:document:sap:rfc:functions:Z_MPG:Z_MPGCONSUMResponse")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults = true)]
        System.Threading.Tasks.Task<SAPServices.Z_MPGCONSUMResponse1> Z_MPGCONSUMAsync(SAPServices.Z_MPGCONSUMRequest request);

        [System.ServiceModel.OperationContractAttribute(Action = "urn:sap-com:document:sap:rfc:functions:Z_MPG:Z_MPGCORESPONDENTARequest", ReplyAction = "urn:sap-com:document:sap:rfc:functions:Z_MPG:Z_MPGCORESPONDENTAResponse")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults = true)]
        ...
        [System.ServiceModel.OperationContractAttribute(Action = "urn:sap-com:document:sap:rfc:functions:Z_MPG:Z_MPGFRAZERISCRequest", ReplyAction = "urn:sap-com:document:sap:rfc:functions:Z_MPG:Z_MPGFRAZERISCResponse")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults = true)]
        ...
        [System.ServiceModel.OperationContractAttribute(Action = "urn:sap-com:document:sap:rfc:functions:Z_MPG:Z_MPGNEWMATERIALSRequest", ReplyAction = "urn:sap-com:document:sap:rfc:functions:Z_MPG:Z_MPGNEWMATERIALSResponse")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults = true)]
        ...
        [System.ServiceModel.OperationContractAttribute(Action = "urn:sap-com:document:sap:rfc:functions:Z_MPG:Z_MPGPREDARERequest", ReplyAction = "urn:sap-com:document:sap:rfc:functions:Z_MPG:Z_MPGPREDAREResponse")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults = true)]
        System.Threading.Tasks.Task<SAPServices.Z_MPGPREDAREResponse1> Z_MPGPREDAREAsync(SAPServices.Z_MPGPREDARERequest request);

        [System.ServiceModel.OperationContractAttribute(Action = "urn:sap-com:document:sap:rfc:functions:Z_MPG:Z_PRODORDERSRequest", ReplyAction = "urn:sap-com:document:sap:rfc:functions:Z_MPG:Z_PRODORDERSResponse")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults = true)]
        System.Threading.Tasks.Task<SAPServices.Z_PRODORDERSResponse1> Z_PRODORDERSAsync(SAPServices.Z_PRODORDERSRequest request);

        [System.ServiceModel.OperationContractAttribute(Action = "urn:sap-com:document:sap:rfc:functions:Z_MPG:Z_UPDTSTATUSPORequest", ReplyAction = "urn:sap-com:document:sap:rfc:functions:Z_MPG:Z_UPDTSTATUSPOResponse")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults = true)]
    ...
    public partial class Z_MPGClient : System.ServiceModel.ClientBase<SAPServices.Z_MPG>, SAPServices.Z_MPG {
        ...
        /// <summary>
        /// Used to get the production orders
        /// </summary>
        /// <param name="Z_PRODORDERS">Object that contains the period and plant</param>
        /// <returns>Task that executes async</returns>
